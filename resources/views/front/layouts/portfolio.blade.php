...
<ul class="list-unstyled row portfolio-box-v2 no-margin-bottom">
    <li class="col-sm-3">
        <a class="fancybox" data-rel="gallery" title="Project One" href="{{ asset('assets/img/main/img12.jpg') }}">
    ...
    <li class="col-sm-3">
        <a class="fancybox" data-rel="gallery" title="Project Two" href="{{ asset('assets/img/main/img6.jpg') }}">
    ...
    <li class="col-sm-3">
        <a class="fancybox" data-rel="gallery" title="Project Three" href="{{ asset('assets/img/main/img17.jpg') }}">
    ...
    <li class="col-sm-3">
        <a class="fancybox" data-rel="gallery" title="Project Four" href="{{ asset('assets/img/main/img25.jpg') }}">
            <img class="img-responsive" src="{{asset('assets/img/main/img25.jpg') }}" alt="">
            <span class="portfolio-box-v2-in">
                <i class="rounded-x icon-magnifier-add"></i>
            </span>
        </a>
