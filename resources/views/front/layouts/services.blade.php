...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="service-block-v1">
                ...
                <p>Sondeo Eléctrico Vertical (S.E.V.). Perforación. Inspección y evaluación de acuíferos.</p>
                {{-- <a class="btn-u btn-u-md" href="#">Leer más</a> --}}
            </div>
        </div>
        <div class="col-sm-4">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="service-block-v1">
                <img alt="" src="{{ asset('assets/img/servicios/resistividad.svg') }}" class="image-md margin-bottom-20">
                <h3 class="title-v3-bg text-uppercase">Resistividad Eléctrica</h3>
                <p>Resistividad eléctrica (Método Wenner).Definición de puesta a tierra y pararayos.</p>
                {{-- <a class="btn-u btn-u-md" href="#">Leer más</a> --}}
            </div>
        </div>
    </div><!--/row-->
