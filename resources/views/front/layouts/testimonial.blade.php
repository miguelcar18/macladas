...
<div class="bg-color-light margin-bottom-60">
    <div class="container content-md">
        <div class="headline-center-v2 headline-center-v2-dark margin-bottom-60">
            ...
            <p>
                Phasellus vitae ipsum ex. Etiam eu vestibulum ante. <br>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="testimonials-v4 md-margin-bottom-50">
                    ...
                    <img class="rounded-x" src="{{ asset('assets/img/testimonials/img5.jpg') }}" alt="thumb">
            ...
            <div class="col-sm-6">
                <div class="testimonials-v4">
                    ...
                    <img class="rounded-x" src="{{ asset('assets/img/testimonials/img4.jpg') }}" alt="thumb">
                    <span class="testimonials-author">
                        John Davenport<br>
