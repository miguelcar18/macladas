...
<div class="container content-sm">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="thumbnails-v1">
                <div class="thumbnail-img">
                    <img class="img-responsive" src="{{ asset('assets/img/masonry/blog2.jpg') }}" alt="">
                </div>
                <div class="caption">
        ...
        <div class="col-sm-4">
            <div class="thumbnails-v1">
                <div class="thumbnail-img">
                    <img class="img-responsive" src="{{ asset('assets/img/masonry/blog3.jpg') }}" alt="">
                </div>
                <div class="caption">
        ...
        <div class="col-sm-4">
            <div class="thumbnails-v1">
                <div class="thumbnail-img">
                    <img class="img-responsive" src="{{ asset('assets/img/masonry/blog4.jpg') }}" alt="">
                </div>
                <div class="caption">
